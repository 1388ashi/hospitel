@foreach($insurances as $insurance)
    <div class="modal fade mt-5" tabindex="-1" id="edit-menu-{{ $insurance->id }}" role="dialog"
         aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="min-width: 50vw;">
                <div class="modal-header">
                    <p class="modal-title font-weight-bolder">ویرایش بیمه</p>
                    ...
                    <form action="{{route('admin.insurances.update', $insurance->id)}}" method="POST">
                        ...
                        <div class="row">
                            <div class="col form-group">
                                <label class="font-weight-bold">نام بیمه :</label><span class="text-danger">&starf;</span>
                            ...
                            <div class="col form-group">
                                ...
                                <input type="text" name="discount" class="comma form-control" value="{{ $insurance->discount }}"
                                required/>
                            </div>
                        </div>
                        <label class="form-label mt-1 ml-5">نوع بیمه: <span class="text-danger">&starf;</span></label>
                            <div class="d-flex">
                                <label class="custom-control custom-radio success ml-4">
                                    <input type="radio" class="custom-control-input" name="type" value="basic" @if($insurance->type == 'basic') checked @endif>
                                    <span class="custom-control-label">پایه</span>
                                </label>
                                <label class="custom-control custom-radio success ml-4">
                                    <input type="radio" class="custom-control-input" name="type" value="supplementary" @if($insurance->type == 'supplementary') checked @endif>
